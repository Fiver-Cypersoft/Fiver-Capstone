  ...
  return (
    <div className="my-36">
      <div className="container">
        <h1 className="text-[14px] text-[#74767e] ml-2">{data?.length} services is available</h1>
              ...
              <div className="border  relative">
                <div className="p-2">
                  ...
                  <div className="flex mt-2 gap-2 items-center">
                    <div>
                      <img className="rounded-full" src={item?.avatar} width={30} height={"auto"} />
                    </div>
                    <div>
                  ...
                  <div className="">
                    <Link to={`/detailJob/${item?.congViec?.id}`} className="pt-4 no-underline">
                      <p className=" text-gray-800 hover:text-green-500">
                    ...
                    <p className="mt-2 flex items-center gap-2 text-[#ffbe5b] font-bold">
                      ...
                      <span className="text-[#b5b6ba]">({item?.congViec?.danhGia})</span>
                    </p>
                  </div>
                </div>
                <div className="border-t mt-8">
                  <div className="p-2 text-[#b5b6ba] flex font-bold justify-between">
                    <svg
